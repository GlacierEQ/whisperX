...
DIRECTORIES = [
    (
        ...
        r"\Compressed - Sorted By 4-Organizer Ultra"
    ),
    r"C:\Users\casey\.sequential-thinking\Downloads",
    r"C:\Users\casey\OneDrive\Documents\GitHub",
    (
        r"C:\Users\casey\.sequential-thinking\.vscode"
        r"\extensions\bitlang.cobol-25.4.30\resources\mermaid\chunks"
    ),
]
...
def scan_dir(root):
    for dirpath, dirnames, filenames in os.walk(root):
        ...
        #     f
        #     for f in filenames
        #     if os.path.splitext(f)[1] in {'.zip', '.rar', '.7z'}
        # ]
        # if archives:
        #     results.append(
        #         {'type': 'Archive', 'path': dirpath, 'noteworthy': archives}
        #     )
